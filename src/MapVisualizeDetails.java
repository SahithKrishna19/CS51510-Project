...
public class MapVisualizeDetails extends JFrame {
    ...
    private static final double FOCAL_LENGTH    = 500; 
        ...
        public MapVisualizeDetails(HashMap<String, City> citiesDS, Map<String, ArrayList<Integer>> weatherRiskMap, long startTime) {
            setTitle("City Map");
                        ...
                        for (CityConnectionStruct ccs : city.connections){
                                ...
                                if (connCity != null){
                                    ...
                                    if (isPointOnLine(e.getPoint(), point1, point2)) {
                                        ...
                                        String b = String.format("Distance : " + distance + " miles \n" +
                                        " Expected time taken = " + ((c.startTime - startTime) * 1.0 /60000) + " min \n" +
                                        " Weather : " + WeatherParse.getNearestWeather(startTime, city.weatherData) + " \n" +
                                        " Gas Consumption : " + (distance / (c.mileage * 3.78541/1.6)) + " gallons\n" ); 
